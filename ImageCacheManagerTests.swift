...
import XCTest
import Combine
@testable import JigneshK_iOSTechTestLBG
...
class MockNetworkManager: NetworkManagerProtocol {
    ...
    func fetchCharacters(completion: @escaping (Result<JigneshK_iOSTechTestLBG.CharacterResponse, JigneshK_iOSTechTestLBG.NetworkError>) -> Void) {
